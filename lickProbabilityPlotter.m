...
STIM_DIRECTORY = 'D:\StimData\JS0137'; % Set directory containing .xsg files
BEHAVIOR_LOCATION = saved_history; % Specify locatison of BControl behavior Data
TRIAL_RANGE = [2:310]; %Specify which trials to use 
MOUSE_NAME = 'AH0107';
DATE = '2015_04_11'; %Set date at which recordins are taken
PATH = 'C:\Users\shires\Documents\BehaviorData\Stim_vs_NoStim\AH0107';
...
motorPosBins = (180000/bins):(180000/bins):180000;
xAll = motorPosBins;
