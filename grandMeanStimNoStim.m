...
FOLDER_LIST = {'113' '124' '125' '128' '130'};
...
for i = 1:numFolders
    ...
    if strcmpi('D:\StimData\JS0113',actDir) == 1; %Friday the 13th filter
    numTrials = (299);
    onFilter = 2;
    offFilter = numTrials;
    ...
    elseif strcmpi('D:\StimData\JS0130',actDir) == 1; %April 9th filter
    numTrials = (207);
    onFilter = 2;
    offFilter = numTrials;
    ...
    elseif strcmpi('D:\StimData\JS0128',actDir) == 1; 
    numTrials = (255);
    onFilter = 2;
    offFilter = numTrials;
    ...
    elseif strcmpi('D:\StimData\JS0124',actDir) == 1; 
    numTrials = (300);
    onFilter = 50;
    offFilter = numTrials;
    ...
    [lickCountStim(i,:), trialCountStim(i,:)] = grandMeanNoStimCalc(saved_history, actDir, bins, onFilter, offFilter);
    
    elseif strcmpi('D:\StimData\JS0125',actDir) == 1; 
    numTrials = (293);
    onFilter = 2;
    offFilter = numTrials;
...
for i = 1:numFolders
    ...
    if strcmpi('D:\StimData\JS0113',actDir) == 1;
    numTrials = (299);
    onFilter = 2;
    offFilter = numTrials;
